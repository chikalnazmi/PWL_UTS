...
.sidebar {
    ...
    background-color: #7e8c69; /* Sage green background */
    padding: 15px;
    border-radius: 10px;
}
...
.sidebar .nav-pills .nav-link:hover {
    background-color: #BFE8D0; /* Slightly brighter sage green on hover */
    color: #333;
}

.form-control-sidebar {
    background-color: #F2F2F2;
    border: 1px solid #C2E0C6; /* Light green border */
    border-radius: 20px;
}

.form-control-sidebar::placeholder {
    color: #8C9A9B; /* Light grayish-green placeholder */
}

.input-group-append .btn-sidebar {
    background-color: #CD8587;
