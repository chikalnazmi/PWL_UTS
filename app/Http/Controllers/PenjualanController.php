...
class PenjualanController extends Controller
{
    ...
    {
        $penjualan = PenjualanModel::select('penjualan_id', 'fk_user_id', 'pembeli', 'penjualan_kode', 'penjualan_tanggal')
            ->with('user');

        if ($request->fk_user_id) {
            $penjualan->where('fk_user_id', $request->user_id);
        }
    ...
    {
        $penjualan = PenjualanModel::find($id);
        $user = UserModel::select('fk_user_id', 'username')->get();
