...
class BarangController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $barang = BarangModel::select('barang_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual', 'fk_kategori_id')
            ->with('kategori'); // memuat relasi kategori
        
        // Filter data barang berdasarkan kategori_id
        if ($request->kategori_id) {
            $barang->where('fk_kategori_id', $request->kategori_id);
        }
    ...
    public function export_excel()
    {
        ...
        $barang = BarangModel::select('fk_kategori_id', 'barang_kode', 'barang_nama', 'harga_beli', 'harga_jual')
            ->orderBy('kategori_id')
            ->with('kategori')
            ->get();
        // load library excel
